...
def analyze_changes(baseline: dict[str, Any] | None, current: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "message": "Compared with the most recent earlier scan that used the same audit sections.",
        "counts": {
